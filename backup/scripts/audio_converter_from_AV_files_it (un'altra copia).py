...
class AudioConverter(QDialog):
    ...
    def _build_ui(self):
        ...
        try:
            ...
            pass
        add_row_centered(lbl_rev, self.cmb_rev, QLabel("   "), lbl_st, self.cmb_stereo, stretch_last=True)

        # ---------------- RIGA 7B: Compressore ----------------
        lbl_comp = QLabel("Compressore:", self)
        ...
        add_row_centered(lbl_comp, self.cmb_comp_soft, stretch_last=True)
        ...
        footer_box.setSizePolicy(QSizePolicy.Expanding, QSizePolicy.Fixed)  # <— SI ESPANDE A TUTTA LARGHEZZA
        ...
        footer.addStretch(1)  # separatore elastico
        ...
        # IMPORTANTE: aggiungi il footer al layout principale **senza** centrarlo
        vmain.addWidget(footer_box)  # niente AlignHCenter: ora i bottoni stanno al margine destro

        # ---------------- Selettore di profilo (mutua esclusione + regole) ----------------
        self._active_profile = "none"
        self._stereo_enh_saved = None  # (index, enabled)
